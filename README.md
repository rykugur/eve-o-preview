...
| Minimize inactive clients Animation| if Minimize Clients is set, this setting will enable window animations (if checked) or disable if unchecked. 
...
| Color | The color of the font for the overlay label |
